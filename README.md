...
Распакуйте архив **heroes_final_project.rar** в любом удобном месте. По пути архива с распакованной игрой не должно быть кириллицы. Запустите игру одним из двух способов:

1. Убедитесь, что у вас стоит Java, и дважды щёлкните левой кнопкой мыши по файлу **Heroes Battle-1.0.0.jar**.
2. Откройте *powershell* в папке, в которой распаковали игру, и выполните команду *java -jar "Heroes Battle-1.0.0.jar"*. Этот вариант предпочтительнее, так как вы сможете видеть лог работы игры в терминале.
